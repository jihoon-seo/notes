...
![Get your AWS access keys](farmoni-guide-figures/01-get-your-aws-access-keys.png)
- AWS 콘솔 접속. https://console.aws.amazon.com/iam/home?region=ap-northeast-2#
- IAM 사용자 추가 및 인증 키 (.csv) 다운로드
![AWS - Create IAM user](farmoni-guide-figures/02-aws-create-iam-user.png)
![AWS - Create IAM user](farmoni-guide-figures/03-aws-create-iam-user.png)
![AWS - Add user to group](farmoni-guide-figures/04-aws-add-user-to-group.png)
![AWS - Confirm user creation](farmoni-guide-figures/05-aws-confirm-user-creation.png)
![AWS - IAM user created](farmoni-guide-figures/06-aws-iam-user-created.png)
...
![A guide for GCE](farmoni-guide-figures/08-gce-guide.png)
- 프로젝트 생성
  - https://console.cloud.google.com/projectselector2/home/dashboard?organizationId=0&supportedpurview=project&authuser=2
![GCP - Create project](farmoni-guide-figures/07-gcp-create-project.png)
- API 접속을 위한 서비스 계정 생성
  ...
  ![GCP - Create IAM user](farmoni-guide-figures/09-gcp-create-iam-user.png)
  - 키 생성 및 다운로드
...
```
- 해당 퍼블릭 키를 GCE에 등록
![GCP - Register SSH key](farmoni-guide-figures/10-gcp-register-ssh-key.png)
- 에이전트 통신을 위한 방화벽 추가
  ...
  ![GCP - Firewall rules](farmoni-guide-figures/11-gcp-firewall-rules.png)
  ![GCP - Create firewall rules](farmoni-guide-figures/12-gcp-create-firewall-rule.png)
