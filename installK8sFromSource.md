...
```
* Install CNI binaries (3 options)
  - Install using package manager: install `kubernetes-cni` package. (You may need to add appropriate repo.)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDgwNzkyMDFdfQ==
-->